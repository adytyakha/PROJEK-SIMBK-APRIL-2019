				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="courses.html"> Materi</a></p>
						</div>	
					</div>
				</div>
			</section>
					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center">
								...
								<p>Silahkan klik judul maka akan di arahkan ke download.</p>
							</div>
						</div>
					</div>						
					<div class="row">
						...
						<div class="single-popular-carusel col-lg-3 col-md-6">
							<div class="thumb-wrap relative">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>	
									<img class="img-fluid" src="img/materi.jpg" alt="">
								</div>
																	
							</div>
							<div class="details">
								<a href="'.$array['alamatweb'].'">
									<h4>
										'.$array['judul'].'
									</h4>
								</a>
