		    	...
		    	<div class="row align-items-center justify-content-between d-flex">
			      ...
			      <nav id="nav-menu-container">
			        <ul class="nav-menu">
			          ...
			          <li><a href="about.html">Materi</a></li>

			           <li class="menu-has-children"><a href="">Pesan</a>
			            <ul>
			              <li><a href="blog-home.html">Chat Personal</a></li>
			              <li><a href="blog-single.html">Chat Grub</a></li>
			            </ul>
			          </li>
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="about.html"> Chat App</a></p>
				...
				<div class="container">
					<div class="row justify-content-between align-items-center">
						<div class="col-lg-6 col-md-6 search-course-left">
							...
							<h1 class="text-white">Selamat Datang [<?php echo $data['nama_lengkap'];?>]	</h1>
