      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="../../admin/../../admin/dist/img/avatar5.png" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $data['nama_lengkap'];?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="../../admin/../../admin/dist/img/avatar5.png" class="img-circle" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">MAIN NAVIGATION</li>
         <li class="active" >
          <a href="logout.php">
            <i class="fa  fa fa-whatsapp"></i> <span>Chat Personal</span>
       ...
       <li>
          <a href="../index.php">
            <i class="fa  fa-sign-out"></i> <span>Kembali</span>
...
<head>
	...
	<script type="text/javascript" src="../../admin/js/pesan.js"></script>
</head>
<body>
	<h1>Inbox Pesan</h1>
