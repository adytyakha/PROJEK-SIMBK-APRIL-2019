...
<head>
  ...
  <title>SIM BK | Edit Pendaftaran</title>
  ...
  <?php
    ...
    while($data = mysqli_fetch_array($query)){
        ?>
            ...
            <form action="../../setting/edituser.php" method="POST">
              <div class="box-body">
                   <div class="form-group has-feedback">
        <label>Id</label>
        <input id="id_member" name="id_member" type="id" class="form-control" placeholder="Id Member" value="<?php echo $data['id_member']; ?>" readonly>
       
              </div>
                
                <div class="form-group has-feedback">
        <label>Nama Lengkap</label>
        <input id="nama_lengkap" name="nama_lengkap" type="text" class="form-control" placeholder="Nama Lengkap" value="<?php echo $data['nama_lengkap']; ?>" required>
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
              </div>
                <div class="form-group has-feedback">
        <label>Alamat</label>
        <input id="alamat" name="alamat" type="text" class="form-control" placeholder="Alamat" value="<?php echo $data['alamat']; ?>" required>
        <span class="fa fa-home form-control-feedback"></span>
      </div>
                  <div class="form-group has-feedback">
        <label>Asal Sekolah</label>
        <input id="asal_sekolah" name="asal_sekolah" type="text" class="form-control" placeholder="Asal Sekolah" value="<?php echo $data['asal_sekolah']; ?>" required>
    ...
    <Label>Jenis Kelamin</Label><br>
                <label>
                  <input id="optionsRadios1" type="radio"  name="jk" class="minimal" value="Laki-laki"  checked>
                </label>
                <label>
                  Laki-laki
                </label>
 <label>
                  <input id="optionsRadios2" type="radio"  name="jk"  class="minimal" value="Perempuan" >
                </label>
                <label>
                  Perempuan
                </label>
...
<div class="form-group has-feedback">
        <label>No.Hp </label>
        <input id="hp" name="hp" type="text" class="form-control" placeholder="No Hp" value="<?php echo $data['hp']; ?>" required>
        <span class="fa fa-phone form-control-feedback"></span>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input id="tglahir" name="tglahir" type="text" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask value="<?php echo $data['tglahir']; ?>">
                </div>
  ...
  <div class="row">
            <div class="col-md-6">
              <div class="form-group" >
                  <label>Agama</label>
                  <select name="agama" value="<?php echo $data['agama']; ?>" id="agama" class="form-control"  >
...
<div class="form-group has-feedback">
        <label>Email</label>
        <input id="email" name="email" type="text" class="form-control" placeholder="Email" value="<?php echo $data['email']; ?>" required>
...
<div class="form-group has-feedback">
  <label>Username</label>
        <input id="username" name="username" type="text" class="form-control" placeholder="Username" value="<?php echo $data['username']; ?>" required>
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>

      <div class="form-group has-feedback">
        <label>Password</label>
        <input id="password" name="password" type="text" class="form-control" placeholder="password" value="<?php echo $data['password'];  ?>"required>
        ...
        <div class="form-feedback">
          <button id="edituseruser" name="edituser" type="submit" class="btn btn-primary btn-block btn-flat">Register</button>
        </div>
