...
<li class="treeview">
    ...
    <li class="treeview">
          ...
          <li class="treeview">
           <li ><a href="konseling.php"><i class="fa fa-bell"></i> <span> Konseling</span>
...
<section class="content">
  ...
  <div class="box-body">
        ...
        <input id="nama_lengkap" name="nama_lengkap" type="text" class="form-control" placeholder="Nama Lengkap" value="<?php echo $user['id']?>">
    ...
    <Label>Jenis Kelamin</Label><br>
                <label>
                  <input id="optionsRadios1" type="radio" value="laki" name="jk" class="minimal" value="<?php echo $data['jk']; ?>"checked>
                </label>
                <label>
                  Laki-laki
                </label>
