...
<li class="treeview">
  ...
  <li class="treeview">
          ...
          <li class="treeview">
           <li class="active" ><a href="konseling.php"><i class="fa fa-bell"></i> <span> Konselor</span>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data Konselor</li>
      </ol>
    </section>
  ...
  <div class="box-body">
            ...
            <div class="col-lg-4 col-md-6 search-course-right section-gap">
              <form class="form-wrap" action="../../setting/tambahkonselor.php" method="post" enctype="multipart/form-data">
                <h4 class="text-white pb-20 text-center mb-30">Data Konselor</h4>
                ...
                <textarea type="email" class="form-control" id="aspirasi" name="aspirasi" placeholder="Aspirasi" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your Email Address'" ></textarea>   
                <br>       
