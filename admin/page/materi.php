...
<li class="treeview">
  ...
  <li class="treeview">
           <li class="active"><a href="materi.php"><i class="glyphicon glyphicon-blackboard"></i> <span> Materi</span>
...
<div class="content-wrapper">
  ...
  <div class="box-body">
            ...
            <form action="../../setting/tambahmateri.php" method="POST">
              <div class="box-body">
                
                <div class="form-group has-feedback">
        <label>Judul Materi</label>
        <input id="judul" name="judul" type="text" class="form-control" placeholder="Judul Materi" required>
        <span class="glyphicon  form-control-feedback"></span>
              </div>
                <div class="form-group has-feedback">
        <label>Alamat Web</label>
        <input id="alamatweb" name="alamatweb" type="text" class="form-control" placeholder="Alamat Web" required>
        ...
        <div class="form-feedback">
          <button id="tambahmateri" name="tambahmateri" type="submit" class="btn btn-primary btn-block btn-flat">Tambah Materi</button>
        </div>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Tabel Materi</li>
      </ol>
    </section>
                        ...
                        while($array = mysqli_fetch_array($query)){
                          echo '
                                        ...
                                        <tr>
                                            ...
                                            <td> <span class="name">'.$array['judul'].'</span> </td>
                                            <td> <span class="name">'.$array['alamatweb'].'</span> </td>
                                            <td> <span class="name">'.$array['keterangan'].'</span> </td>
                                            ...
                                            <td>
                                                ...
                                                <span><a href="../../setting/hapusmateri.php?id='.$array['id'].'"><button type="button" class="btn btn-danger btn-sm">Delete</button></a></span>
                                            </td>
